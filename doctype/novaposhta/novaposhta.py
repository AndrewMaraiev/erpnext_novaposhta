...
class NovaPoshtaUtils:
    def __init__(self, api_key: str = None):
        ...
        self.api = NovaPoshtaApi(api_key='YOUR_API_KEY')
        if not self.enabled:
    ...
    def create_shipment(
        ...
        def create_express_waybill(
            city_sender_ref, sender_ref, sender_address_ref, sender_contact_ref, sender_contact_phone,
            city_recipient_ref, recipient_ref, recipient_address_ref, recipient_contact_ref, recipient_contact_phone
        ):
            result = post(self.api_endpoint, json={
                "apiKey": self.api_key,
                "modelName": "InternetDocument",
